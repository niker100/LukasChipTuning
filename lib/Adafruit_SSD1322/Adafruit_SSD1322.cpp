...
bool Adafruit_SSD1322::oled_commandAndArgsList(const uint8_t *c, uint8_t n) {
...
//   Serial.println(")");
  ...
  uint16_t x_start = min((int16_t)(WIDTH-1), (int16_t)window_x1);
  uint16_t x_end = max((int16_t)0, (int16_t)window_x2);
